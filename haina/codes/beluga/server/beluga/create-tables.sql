...
create table ContactUser (id char(32) not null, version int8 not null, logingName varchar(64) not null unique, registerTime timestamp, mobile varchar(64) not null unique, lastLoginTime timestamp, lastLoginIp varchar(64), validFlag bool not null, remark varchar(2000), primary key (id));
