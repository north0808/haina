...
drop table Weather;
create table ContactUser (id varchar(32) not null, version int8 not null, logingName varchar(64) not null unique, registerTime timestamp not null, mobile varchar(64) not null unique, lastLoginTime timestamp, lastLoginIp varchar(64), remark varchar(2000), primary key (id));
