 ...
 *
 * <p>
 * How would we include the <em>hobbies</em> field?  Using the {@link com.haina.beluga.webservice.flexjson.JSONSerializer#include}
 ...
 * {@link com.haina.beluga.webservice.flexjson.JSON}.  You can include and exclude fields permenantly using the
 ...
 * those fields, and use the {@link com.haina.beluga.webservice.flexjson.JSONSerializer#include} method.
 * </p>
 *
 * <p>
 ...
 * allow you to do this.  Flexjson ships with a simple HTML encoder {@link com.haina.beluga.webservice.flexjson.HTMLEncoder}.
 ...
 * threads.  It is NOT safe to use combination of {@link com.haina.beluga.webservice.flexjson.JSONSerializer#include(String[])}
 * {@link JSONSerializer#transform(Transformer, String[])}, or {@link com.haina.beluga.webservice.flexjson.JSONSerializer#exclude(String[])}
 * from multiple threads at the same time.  It is also NOT safe to use
 * {@link com.haina.beluga.webservice.flexjson.JSONSerializer#serialize(String, Object)} and include/exclude/transform from
...
public class JSONSerializer {
     ...
     * named rootName.  This is great to use in conjunction with other libraries
     * like EXTJS whose data models require them to be wrapped in a JSON object.
     * See {@link com.haina.beluga.webservice.flexjson.JSONSerializer#deepSerialize(Object)} for more
