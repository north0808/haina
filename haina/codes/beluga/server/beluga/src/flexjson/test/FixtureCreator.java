...
import flexjson.test.mock.Network;
import flexjson.test.mock.Person;
import flexjson.test.mock.Phone;
import flexjson.test.mock.PhoneNumberType;
import flexjson.test.mock.Zipcode;
import flexjson.test.mock.superhero.Flight;
import flexjson.test.mock.superhero.HeatVision;
import flexjson.test.mock.superhero.Hero;
import flexjson.test.mock.superhero.Invincible;
import flexjson.test.mock.superhero.SecretIdentity;
import flexjson.test.mock.superhero.SecretLair;
import flexjson.test.mock.superhero.Villian;
import flexjson.test.mock.superhero.XRayVision;
