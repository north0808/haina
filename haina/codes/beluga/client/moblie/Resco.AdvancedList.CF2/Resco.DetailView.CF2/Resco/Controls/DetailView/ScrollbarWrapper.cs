namespace Resco.Controls.DetailView
{
    ...
    internal class ScrollbarWrapper
    {
        ...
        private Resco.Controls.DetailView.ScrollOrientation m_scrollOrientation;

        public event EventHandler Resize;

        public event EventHandler ValueChanged;

        public ScrollbarWrapper(Control scrollbar, Resco.Controls.DetailView.ScrollOrientation scrollOrientation)
        {
        ...
        public Resco.Controls.DetailView.ScrollOrientation ScrollOrientation
        {
            get
            {
