namespace Resco.Controls.AdvancedList
{
    ...
    public class Mapping
    {
        ...
        private static Resco.Controls.AdvancedList.Mapping s_Empty;
        ...
        {
            return this.GetRowPropertyDescriptors();
        }
        ...
        public static Resco.Controls.AdvancedList.Mapping Empty
        {
            get
            {
                if (s_Empty == null)
                {
                    s_Empty = new Resco.Controls.AdvancedList.Mapping();
                }
                return s_Empty;
            }
        }
        ...
        private class RowDescriptor : PropertyDescriptor
        {
            public RowDescriptor(string name) : base(name, null)
            {
            }

            public override bool CanResetValue(object component)
            {
                return (component is Row);
            }

            public override object GetValue(object component)
            {
                return ((Row) component)[this.Name];
            }

            public override void ResetValue(object component)
            {
                ((Row) component)[this.Name] = null;
            }

            public override void SetValue(object component, object value)
            {
                ((Row) component)[this.Name] = value;
            }
