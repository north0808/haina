namespace Resco.Controls.CommonControls
{
    ...
    internal class ToolbarConversion
    {
        public ToolbarControl.DesignTimeCallback m_DesignTimeCallback;
        private Hashtable m_htImageLists;
        private ISite m_site;

        public ToolbarConversion(ToolbarControl.DesignTimeCallback _designTimeCallback)
        {
