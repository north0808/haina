namespace Resco.Controls.AdvancedComboBox
{
    ...
    public class GradientColor
    {
        ...
        private Resco.Controls.AdvancedComboBox.FillDirection m_fillDirection;
        ...
        public GradientColor()
        {
            ...
            this.m_fillDirection = Resco.Controls.AdvancedComboBox.FillDirection.Horizontal;
        }

        public GradientColor(Resco.Controls.AdvancedComboBox.FillDirection fillDirection) : this()
        {
        ...
        public GradientColor(Color startColor, Color endColor, Resco.Controls.AdvancedComboBox.FillDirection fillDirection)
        {
            this.m_startColor = startColor;
            this.m_endColor = endColor;
            this.m_middleColor1 = Color.Transparent;
        ...
        {
            return (this.m_fillDirection != Resco.Controls.AdvancedComboBox.FillDirection.Horizontal);
        }
        ...
        public Resco.Controls.AdvancedComboBox.FillDirection FillDirection
        {
            get
            {
