namespace Resco.Controls.AdvancedComboBox
{
    ...
    public class Mapping
    {
        ...
        private static Resco.Controls.AdvancedComboBox.Mapping s_Empty;
        ...
        public static Resco.Controls.AdvancedComboBox.Mapping Empty
        {
            get
            {
                if (s_Empty == null)
                {
                    s_Empty = new Resco.Controls.AdvancedComboBox.Mapping();
                }
                return s_Empty;
            }
        }
        ...
        {
            public ItemDescriptor(string name) : base(name, null)
            {
            }

            public override bool CanResetValue(object component)
            {
                return (component is ListItem);
            }

            public override object GetValue(object component)
            {
                return ((ListItem) component)[this.Name];
            }

            public override void ResetValue(object component)
            {
                ((ListItem) component)[this.Name] = null;
            }

            public override void SetValue(object component, object value)
            {
                ((ListItem) component)[this.Name] = value;
            }
