namespace Resco.Controls.OutlookControls
{
    ...
    internal sealed class GradientFill
    {
        ...
        internal static Color GetColorDarker(Color aColor)
        {
            int red = (int) (((double) aColor.R) / 2.0);
            int green = (int) (((double) aColor.G) / 2.0);
            int blue = (int) (((double) aColor.B) / 2.0);
        ...
        internal static Color GetColorLighter(Color aColor)
        {
            int red = (int) (((double) (0xff + aColor.R)) / 2.0);
            int green = (int) (((double) (0xff + aColor.G)) / 2.0);
            int blue = (int) (((double) (0xff + aColor.B)) / 2.0);
            return Color.FromArgb(red, green, blue);
        }
