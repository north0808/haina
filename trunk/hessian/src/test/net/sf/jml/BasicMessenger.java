...
public class BasicMessenger {
    ...
    public static void main(String[] args) throws Exception {
    	HelloMessenger msn = (HelloMessenger) Class.forName("test.net.sf.jml.HelloMessenger").newInstance();//创建类实例  
         msn.setEmail("fuxiang2009@live.cn");//设置登录用户  
         msn.setPassword("6687349a");//设置密码  
         msn.start();  
