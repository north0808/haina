...
CREATE TABLE qrtz_job_details
  (
    JOB_NAME  NVARCHAR2(80) NOT NULL,
    JOB_GROUP NVARCHAR2(80) NOT NULL,
    DESCRIPTION NVARCHAR2(120) NULL,
    JOB_CLASS_NAME   NVARCHAR2(128) NOT NULL, 
    IS_DURABLE NVARCHAR2(1) NOT NULL,
    IS_VOLATILE NVARCHAR2(1) NOT NULL,
    IS_STATEFUL NVARCHAR2(1) NOT NULL,
...
CREATE TABLE qrtz_job_listeners
  (
    JOB_NAME  NVARCHAR2(80) NOT NULL, 
    JOB_GROUP NVARCHAR2(80) NOT NULL,
    JOB_LISTENER NVARCHAR2(80) NOT NULL,
...
CREATE TABLE qrtz_triggers
  (
    ...
    CALENDAR_NAME NVARCHAR2(80) NULL,
...
CREATE TABLE qrtz_cron_triggers
  (
    TRIGGER_NAME NVARCHAR2(80) NOT NULL,
    TRIGGER_GROUP NVARCHAR2(80) NOT NULL,
    CRON_EXPRESSION NVARCHAR2(80) NOT NULL,
...
CREATE TABLE qrtz_trigger_listeners
  (
    TRIGGER_NAME  NVARCHAR2(80) NOT NULL, 
    TRIGGER_GROUP NVARCHAR2(80) NOT NULL,
    TRIGGER_LISTENER NVARCHAR2(80) NOT NULL,
...
CREATE TABLE qrtz_calendars
  (
    CALENDAR_NAME  NVARCHAR2(80) NOT NULL, 
...
CREATE TABLE qrtz_fired_triggers 
  (
    ...
    TRIGGER_GROUP NVARCHAR2(80) NOT NULL,
    IS_VOLATILE NVARCHAR2(1) NOT NULL,
    INSTANCE_NAME NVARCHAR2(80) NOT NULL,
    FIRED_TIME NUMBER(13) NOT NULL,
    STATE NVARCHAR2(16) NOT NULL,
    JOB_NAME NVARCHAR2(80) NULL,
    JOB_GROUP NVARCHAR2(80) NULL,
    IS_STATEFUL NVARCHAR2(1) NULL,
