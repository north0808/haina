...
create table Weather (ID varchar(255) not null, date varchar(20), weatherCityCode varchar(20), weatherType varchar(50), high integer, low integer, wind longtext, VERSION bigint, primary key (ID));
