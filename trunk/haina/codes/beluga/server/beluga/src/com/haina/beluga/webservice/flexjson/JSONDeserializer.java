 ...
 * To do that we'll use the {@link com.haina.beluga.webservice.flexjson.JSONDeserializer#use(String, Class)} method like so:
 * </p>
 * <pre>
 ...
 * the Hero class to the root of the json.  The {@link com.haina.beluga.webservice.flexjson.JSONDeserializer#use(String, Class)} method  uses
 ...
 * </p>
 * <p>
 * Before we showed how the {@link com.haina.beluga.webservice.flexjson.JSONDeserializer#use(String, Class)} method would allow us to
 ...
 * possibilities.  That's where the second version of {@link com.haina.beluga.webservice.flexjson.JSONDeserializer#use(String, ClassLocator)}
 * comes into play.  {@link com.haina.beluga.webservice.flexjson.ClassLocator} allow you to use a stradegy for finding which java Class
 * you want to attach at a particular object path.
 * </p>
 * <p>
 * {@link com.haina.beluga.webservice.flexjson.JSONDeserializer#use(String, ClassLocator)} have access to the intermediate form of
 ...
 * the {@link com.haina.beluga.webservice.flexjson.JSONSerializer}.
 * </p>
 */
