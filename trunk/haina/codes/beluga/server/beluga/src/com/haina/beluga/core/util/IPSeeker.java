...
public class IPSeeker{
    ...
    private static final String IP_FILE = "D:/space/soar/WebRoot/WEB-INF/classes/QQWry.Dat";
    ...
    public String getCountry(byte[] ip){
        // 检查ip地址文件是否正常
        if(ipFile == null) return  "error file."; 
        // 保存ip，转换ip字节数组为字符串形式
    ...
    public static void main(String[] arg){
    	System.out.println(IPSeeker.getInstance().getAddress("210.43.7.5"));
