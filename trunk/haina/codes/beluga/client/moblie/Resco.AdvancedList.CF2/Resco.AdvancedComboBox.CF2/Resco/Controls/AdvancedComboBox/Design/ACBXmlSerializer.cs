namespace Resco.Controls.AdvancedComboBox.Design
{
    ...
    internal class ACBXmlSerializer
    {
        ...
        public static void SaveXml(string fileName, Control advancedComboBox)
        {
            XmlWriter writer = null;
            try
            {
                XmlWriterSettings settings = new XmlWriterSettings();
                settings.Indent=true;//.set_Indent(true);
                settings.Encoding=Encoding.UTF8;//.set_Encoding(Encoding.UTF8);
                settings.CloseOutput=true;//.set_CloseOutput(true);
                writer = XmlWriter.Create(fileName, settings);
                writer.WriteStartDocument(true);
                writer.WriteStartElement("DSAdvancedComboBox", "http://www.rescodeveloper.net/schemas/DSAdvancedComboBox.xsd");
                SaveXml(writer, advancedComboBox);
        ...
        public static void SaveXml(XmlWriter writer, Control advancedComboBox)
        {
            new ACBXmlSerializer().XmlSerialize(writer, advancedComboBox);
        }
        ...
        public void XmlSerialize(XmlWriter writer, Control advancedComboBox)
        {
            writer.WriteStartElement("AdvancedComboBox");
            this.SerializeObjectsProperties(writer, advancedComboBox);
            writer.WriteStartElement("DbConnector");
            object propertyValue = ReflectionHelper.GetPropertyValue(advancedComboBox, "DbConnector");
