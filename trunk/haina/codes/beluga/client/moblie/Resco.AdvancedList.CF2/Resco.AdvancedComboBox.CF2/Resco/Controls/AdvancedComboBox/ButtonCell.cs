namespace Resco.Controls.AdvancedComboBox
{
    ...
    public class ButtonCell : Cell
    {
        ...
        {
            Color color = (this.BackColor == Color.Transparent) ? base.Owner.BackColor : this.BackColor;
            Color color2 = (this.m_bColor == Color.Transparent) ? base.Owner.BackColor : this.m_bColor;
            drawbounds.Width--;
            drawbounds.Height--;
            ...
            if (this.Pressed)
            {
                color = (this.m_pBgColor == Color.Transparent) ? base.Owner.BackColor : this.m_pBgColor;
                color2 = (this.m_pBorderColor == Color.Transparent) ? base.Owner.BackColor : this.m_pBorderColor;
            }
        ...
        [DefaultValue(false), Resco.Controls.AdvancedComboBox.Design.Browsable(false), Resco.Controls.AdvancedComboBox.Design.DesignerSerializationVisibility(Resco.Controls.AdvancedComboBox.Design.DesignerSerializationVisibility.Hidden)]
        ...
        public int TouchMargin
        {
            ...
            set
            {
                if (this.m_touchMargin != value)
                {
                    ...
                    if ((base.Parent != null) && (base.Parent.Items != null))
                    {
                        base.Parent.Items.ResetCachedBounds(base.Owner);
                    }
                    base.OnChanged(this, ComboBoxEventArgsType.Repaint, ComboBoxArgs.Default);
                }
            }
