namespace Resco.Controls.AdvancedComboBox.Design
{
    ...
    internal class ReflectionHelper
    {
        ...
        {
            return Type.GetType("Resco.Controls.AdvancedComboBox." + type).GetConstructor(types).Invoke(parameters);
        }
        ...
        {
            return Type.GetType("Resco.Controls.AdvancedComboBox." + type).GetProperty(propertyName).GetValue(null, null);
        }

        internal static Type GetType(string name)
        {
            return Type.GetType("Resco.Controls.AdvancedComboBox." + name);
        }
        ...
        {
            string typeName = "Resco.Controls.AdvancedComboBox." + type;
