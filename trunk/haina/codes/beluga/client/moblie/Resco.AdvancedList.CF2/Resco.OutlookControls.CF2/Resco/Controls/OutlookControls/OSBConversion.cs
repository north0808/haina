namespace Resco.Controls.OutlookControls
{
    ...
    internal class OSBConversion
    {
        public Resco.Controls.OutlookControls.OutlookShortcutBar.DesignTimeCallback DesignTimeCallback;
        private Hashtable m_htImageLists;
        private ISite m_site;

        public OSBConversion(Resco.Controls.OutlookControls.OutlookShortcutBar.DesignTimeCallback _designTimeCallback)
        {
            this.m_htImageLists = new Hashtable();
            this.DesignTimeCallback = _designTimeCallback;
        }

        public OSBConversion(ISite site, Resco.Controls.OutlookControls.OutlookShortcutBar.DesignTimeCallback _designTimeCallback)
        {
            this.m_htImageLists = new Hashtable();
            this.m_site = site;
            this.DesignTimeCallback = _designTimeCallback;
        ...
        public Font FontFromString(string sFont)
        {
            ...
            if (this.DesignTimeCallback != null)
            {
                this.DesignTimeCallback(o, null);
            }
            return o;
        }
