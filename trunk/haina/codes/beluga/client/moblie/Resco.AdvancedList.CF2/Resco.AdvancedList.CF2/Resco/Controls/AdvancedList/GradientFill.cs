            ...
            if (fillDirection == FillDirection.Horizontal)
            {
                ...
                if (top == num6)
                {
                    ...
                    while (num7 < width)
                    {
                        ...
                        Resco.Controls.AdvancedList.AdvancedList.DrawPixel(gr, c, left, top);
                        left++;
                        num7++;
                    }
                }
                else
                {
                    ...
                    while (num12 < width)
                    {
                        ...
                        gr.DrawLine(Resco.Controls.AdvancedList.AdvancedList.GetPen(color2), num13, top, num13, num6);
                        num13++;
                        num12++;
                    }
                }
            ...
            else if (fillDirection == FillDirection.Vertical)
            {
                ...
                if (x == num22)
                {
                    ...
                    for (int i = rc.Top; num23 < height; i++)
                    {
                        ...
                        Resco.Controls.AdvancedList.AdvancedList.DrawPixel(gr, color3, x, i);
                        num23++;
                    }
                }
                else
                {
                    ...
                    for (int j = rc.Top; num28 < height; j++)
                    {
                        ...
                        gr.DrawLine(Resco.Controls.AdvancedList.AdvancedList.GetPen(color4), x, j, num22, j);
                        num28++;
                    }
                }
            }
