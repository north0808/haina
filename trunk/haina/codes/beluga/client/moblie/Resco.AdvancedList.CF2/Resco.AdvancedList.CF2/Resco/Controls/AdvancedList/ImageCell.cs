namespace Resco.Controls.AdvancedList
{
    ...
    {
        private Resco.Controls.AdvancedList.Alignment m_Alignment;
        ...
        public ImageCell()
        {
            ...
            this.m_Alignment = Resco.Controls.AdvancedList.Alignment.TopLeft;
        }
        ...
        {
            return (this.m_Alignment != Resco.Controls.AdvancedList.Alignment.TopLeft);
        }
        ...
        [DefaultValue(10)]
        public Resco.Controls.AdvancedList.Alignment Alignment
        {
            get
            {
