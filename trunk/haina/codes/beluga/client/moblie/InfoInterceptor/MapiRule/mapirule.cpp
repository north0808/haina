            ...
            ULONG cbDestFolder, LPENTRYID lpDestFolder, ULONG *pulEventType, MRCHANDLED *pHandled)
{
	...
	// wcsstr(pspvSubject->Value.lpszW, L"zzz")部分为短信的拦截规则.
...
//     
//////////////////////////////////////////////////////////////////////////////////////////////     
EXTERN_C void CaptureSMSMessages (wchar_t * pi_wcpID)    
{    
    //!!! wcscpy(g_wcaID, pi_wcpID); // Remove by xioahui     
  ...
  //// Copy the filter's phone number to the share filemap memory     
  //if ( g_pClientSmsBuffer)    
  //  wcscpy(g_pClientSmsBuffer->g_szFilterPhone, pi_wcpID);    
  ////!!! End     
