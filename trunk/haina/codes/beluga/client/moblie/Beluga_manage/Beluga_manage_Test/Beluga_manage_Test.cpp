// Beluga_manage_Test.cpp : Defines the entry point for the application.
//
                   ...
                   int       nCmdShow)
{
	...
	HACCEL hAccelTable;
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BELUGA_MANAGE_TEST));
...
ATOM MyRegisterClass(HINSTANCE hInstance, LPTSTR szWindowClass)
{
	...
	wc.hIcon         = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_BELUGA_MANAGE_TEST));
	wc.hCursor       = 0;
...
//
#define KHostName _T("192.168.3.105") 
