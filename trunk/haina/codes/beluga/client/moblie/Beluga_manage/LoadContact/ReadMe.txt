================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : LoadContact Project Overview
===============================================================================

The application wizard has created this LoadContact application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your LoadContact application.
...
LoadContact.h
    ...
    project specific headers and declares the CLoadContactApp application class.

LoadContact.cpp
    This is the main application source file that contains the application
    class CLoadContactApp.
...
LoadContactDlg.h, LoadContactDlg.cpp - the dialog
    These files contain your CLoadContactDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named LoadContact.pch and a precompiled types file named StdAfx.obj.
